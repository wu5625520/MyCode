				...
				<div id="content">
					<div class="login_form">
						<div class="login_box">
							...
							<div class="form">
								<form action="http://localhost:8080/SSM/userControl/regist" method="post">
									...
									<img id="code_img" alt="" src="http://localhost:8080/SSM/code.jpg" style="float: right; margin-right: 40px; width: 80px; height: 40px">
									<br />
									<br />
